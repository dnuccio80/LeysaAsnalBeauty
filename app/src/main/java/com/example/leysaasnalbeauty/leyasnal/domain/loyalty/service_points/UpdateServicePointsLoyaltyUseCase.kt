...
class UpdateServicePointsLoyaltyUseCase @Inject constructor(private val loyaltyRepository: LoyaltyRepository) {
    suspend operator fun invoke(loyalty:LoyaltyServicePointsDataClass) = loyaltyRepository.updateServicePointsLoyalty(loyalty)
}