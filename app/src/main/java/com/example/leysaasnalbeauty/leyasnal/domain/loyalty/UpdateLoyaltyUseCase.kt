...
class UpdateLoyaltyUseCase @Inject constructor(private val loyaltyRepository: LoyaltyRepository) {
    suspend operator fun invoke(loyalty:LoyaltyDataClass) = loyaltyRepository.updateLoyalty(loyalty.toLoyaltyEntity())
}