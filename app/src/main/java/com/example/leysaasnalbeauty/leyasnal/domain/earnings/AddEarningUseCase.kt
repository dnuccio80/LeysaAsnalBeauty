...
class AddEarningUseCase @Inject constructor(private val earningRepository: EarningRepository) {
    suspend operator fun invoke(earning: EarningDataClass) = earningRepository.addEarning(earning)
}