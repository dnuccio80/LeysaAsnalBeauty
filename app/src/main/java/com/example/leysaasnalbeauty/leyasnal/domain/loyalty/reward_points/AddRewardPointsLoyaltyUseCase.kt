...
class AddRewardPointsLoyaltyUseCase @Inject constructor(private val loyaltyRepository: LoyaltyRepository) {
    suspend operator fun invoke(loyalty: LoyaltyRewardPointsDataClass)  = loyaltyRepository.addRewardPointsLoyalty(loyalty)
}